    ...
    <div className="flex flex-col items-center justify-start min-h-screen pt-20">
      ...
      <div className="w-80 mb-4 flex flex-col">
        ...
        <input
          ...
          className={`p-2 border rounded-lg focus:outline-none focus:border-gray-600 text-black ${
      ...
      <div className="px-20">
        <button
          ...
          className={`w-80 py-2 px-8 mb-4 text-white font-semibold rounded-lg transition-colors ${
            buttonDisabled
