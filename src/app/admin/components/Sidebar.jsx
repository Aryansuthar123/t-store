...
import { InboxIcon, ShoppingCart, FileText, LayoutDashboard, Boxes, LogOut, Layers2 } from "lucide-react";
    ...
    <section className="sticky top-0 left-4 flex flex-col gap-10 bg-white px-6 py-3 h-screen overflow-hidden w-[260px] z-[1000]">
      ...
      <ul className="flex-1 overflow-y-auto flex flex-col gap-3">
        {menuList.map((item, key) => (
          <Tab key={key} item={item} pathname={pathname} openMenu={openMenu} setOpenMenu={setOpenMenu} />
        ))}
      </ul>
